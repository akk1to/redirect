...
//Static
const birthdayString = "Birthday: April 24, 2010";
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    let a = new EventSource("https://api.zeno.fm/mounts/metadata/subscribe/ucjm3ysyy98uv");
...
function setRadioText() {
    ...
    document.getElementById("radio-text-1").textContent = "📻 rabin.py little radio! " + mt;
...
function radiotoggle() {
    ...
    if (radio == null) {
        radioIsLoading = true;
        radio = new Audio('https://stream.zeno.fm/ucjm3ysyy98uv');
